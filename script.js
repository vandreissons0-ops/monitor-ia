...
const operadores = [
    { nome: 'Ana Silva',       turno: 'Manhã', carteira: 'AEGEA MT01' },
    { nome: 'Bruno Costa',     turno: 'Tarde', carteira: 'AEGEA MT01' },
    { nome: 'Carla Mendes',    turno: 'Manhã', carteira: 'AEGEA Manaus' },
    { nome: 'Diego Oliveira',  turno: 'Noite', carteira: 'AEGEA Guariroba' },
    { nome: 'Eduarda Lima',    turno: 'Manhã', carteira: 'Equatorial' },
    { nome: 'Felipe Santos',   turno: 'Tarde', carteira: 'Varejo' },
    { nome: 'Gabriela Rocha',  turno: 'Manhã', carteira: 'AEGEA Manaus' },
    { nome: 'Henrique Alves',  turno: 'Noite', carteira: 'AEGEA MT01' },
    { nome: 'Isabela Ferreira',turno: 'Tarde', carteira: 'Equatorial' },
    { nome: 'João Pedro Dias', turno: 'Manhã', carteira: 'Varejo' },
    { nome: 'Karina Souza',   turno: 'Tarde', carteira: 'AEGEA Guariroba' },
    { nome: 'Lucas Barbosa',   turno: 'Manhã', carteira: 'AEGEA MT01' },
];
